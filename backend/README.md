...
## Project Structure
    ...
    ├── testapiautoteammemb_75779  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_75779`
...
2. Clone this repo and `cd testapiautoteammemb_75779`
